...
call <SID>AddPair('may', 'jun')
call <SID>AddPair('jun', 'jul')
call <SID>AddPair('jul', 'aug')
...
call <SID>AddPair('public', 'private')
call <SID>AddPair('protected', 'public')
call <SID>AddPair('private', 'protected')
